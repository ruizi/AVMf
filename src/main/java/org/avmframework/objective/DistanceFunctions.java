...
public class DistanceFunctions {
    ...
    public static double equals(double num1, double num2, double num3) {
        return Math.abs(num1 - num2) + Math.abs(num2 - num3) + Math.abs(num1 - num3) + K;
    }
    ...
    public static double notEquals(double num1, double num2, double num3) {
