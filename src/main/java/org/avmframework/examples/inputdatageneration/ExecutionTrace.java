...
public class ExecutionTrace {
    ...
    public boolean equals(int id, double num1, double num2, double num3) {
        boolean outcome = (num1 == num2) && (num2 == num3);
        double distanceToAlternative;
        if (outcome) {
            distanceToAlternative = DistanceFunctions.notEquals(num1, num2, num3);
        } else {
            distanceToAlternative = DistanceFunctions.equals(num1, num2, num3);
        }
        branchExecutions.add(new BranchExection(id, outcome, distanceToAlternative));
        return outcome;
    }
    ...
    public boolean greaterThan(int id, double num1, double num2) {
        ...
        branchExecutions.add(new BranchExection(id, outcome, distanceToAlternative)); //加入已经执行的节点列表
        return outcome;
    }
